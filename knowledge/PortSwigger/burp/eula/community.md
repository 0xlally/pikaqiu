# Burp Suite Terms & Conditions of Supply

Source: https://portswigger.net/burp/eula/community
Fetched: 2026-06-28T09:16:13.184011+00:00
...
1.2 The terms and conditions set forth in this end user licence agreement (EULA) govern Your purchase of DAST Software and Pro Software. References in these terms and conditions to Software shall mean either DAST Software and / or Pro Software, depending on the selection(s) made in Your completed order form (Order). If You use Our software comprising Burp Suite Community Edition (Burp Suite Community Edition) then the terms set out in Addendum D shall apply to Your use of Burp Suite Community Edition.

1.3 Please carefully read the terms and conditions of this EULA, and any other applicable documentation supplied by Us to assist with Your subscription (including any user and system administrator guides, manuals, functionality specifications, acceptable use policy and online terms) (Documentation).
...
(A) in any manner which unduly burdens or overloads Our systems and/or impacts other users of the Software;
...
(f) You shall not use any autonomous AI products on our online training centre known as Web Security Academy without Our prior written consent. Please contact sales@portswigger.net if You would like to do this.

(g) Subject to clauses 2.2 and 3.4, You shall not:
...
(h) You shall not disassemble, decompile, reverse engineer or create derivative works based on the whole or any part of the Software, nor attempt to do any such thing except to the extent that, under applicable law, such actions cannot be prohibited because they are essential for the purpose of achieving inter-operability of the Software with another software program, and provided that the information obtained by You during such activities is:
...
(c) Where You have an existing Order and We introduce new features relating to the Software licensed to you under that Order, We will notify You and any specific terms applicable to those new features will be added as an addendum to the applicable EULA and form part of the Agreement.

You will be responsible for ensuring You comply with any updated versions of the EULA and Documentation as notified to You by email or made available on Our website, and all new Orders will be subject to the latest versions of the EULA and Documentation.
...
Addendum D - Community Terms

1 Introduction

1.1 In addition to the DAST Software and Pro Software; PortSwigger Ltd is the entire legal and beneficial owner and licensor of the software comprising Burp Suite Community Edition (which is available for download via the Our website at https://portswigger.net/buy).

1.2 Except as set out in this Addendum D, the terms and conditions set forth in EULA also govern Our license and supply and Your use of the Burp Suite Community Edition; provided always that any reference in the EULA to subscription or Order shall mean your subscription and Order for Burp Suite Community Edition only (save that no fees shall be due from You to Us). This Addendum D applies solely to any use of the Burp Suite Community Edition and not to any use of the DAST Software and / or Pro Software.

1.3 For the purpose of this Addendum D, references in the EULA and this Addendum D to Software shall mean Burp Suite Community Edition if You are using the Burp Suite Community Edition, except as amended or varied in this Addendum D.

1.4 Before using the Burp Suite Community Edition, please carefully read the terms and conditions of the EULA and this Addendum D, and any other applicable documentation supplied by Us to assist with Your use (including but not limited to any relevant Documentation).

1.5 In this Addendum D, expressions defined in the EULA and used in this Addendum D have the meaning set out in the EULA unless otherwise defined. The rules of interpretation set out in the EULA apply to this Addendum D.

1.6 Notwithstanding any other communications between the parties, You using and/or downloading the Burp Suite Community Edition, or the download of the Software by another party at Your instigation, shall constitute conclusive evidence that You have downloaded the Burp Suite Community Edition, on the basis of EULA.

2 Amendments to the EULA

2.1 For the purposes of Your use of the Burp Suite Community Edition, the parties agree the following specific amendments to the EULA:

1.

Clause 1.2 of the EULA replaced:

The entire text of clause 1.2 is deleted and replaced with:

"1.2 The terms and conditions set forth in this end user licence agreement (EULA) govern Your use of the Burp Suite Community Edition. References in these terms and conditions to Software shall mean Burp Suite Community Edition, DAST Software and / or Pro Software, depending on the selection(s) made in Your completed order form (Order)."

2.

Clause 1.4 of the EULA replaced:

The entire text of clause 1.4 is deleted and replaced with:

"1.4 This EULA, Your Order and the Documentation will together comprise Your contractual agreement with PortSwigger governing Our provision of and Your licence subscription for Burp Suite Community Edition (Agreement). You are not licensed to sell or resell the Burp Suite Community Edition (under any circumstances)."

3.

Clause 2.1 of the EULA replaced:

The entire text of clause 2.1 is deleted and replaced with:

"2.1 Grant of licence. In consideration of Your use of the Burp Suite Community Edition, We grant to You a non-exclusive, non-transferable, non-sublicensable, revocable, royalty-free, licence to use, for Your internal business purposes (which may, include the provision of a bespoke consultancy service to clients where You are acting in a business advisory capacity), in accordance with the terms of the Agreement:

(a) the Burp Suite Community Edition in object code form only, solely for Your internal business purposes; and

(b) the Documentation as required to support Your use of the Software pursuant to 2.1(a).

You may use the Burp Suite Community Edition to analyse the behaviour and performance of the documented functionality of the Burp Suite Community Edition and any Burp and disclose the findings of such analysis to any party provided that such findings are provided simultaneously and in identical form to Ours."

4.

Clause 3 of the EULA deleted:

The entire text of clause 3 is deleted and replaced with the words "Not used."

5.

Clause 4 of the EULA deleted:

The entire text of clause 4 is deleted and replaced with the words "Not used."

6.

Clause 7.1 of the EULA replaced:

The entire text of clause 7.1 is deleted and replaced with:

"7.1 Subject to clause 7.2, We warrant that, so far as We are aware, on download and installation, where the relevant Software is properly used on the computer(s) with the runtime environment for which it was designed as referred to in the Documentation and in accordance with the terms of the Agreement, the Software will perform substantially in accordance with the Documentation."

7.

Clause 7.3 of the EULA replaced:

The entire text of clause 7.3 is deleted and replaced with:

"7.3 If, on download and/or installation of the Software, You notify Us in writing of any failure of the Software to comply with such warranty, and such failure does not result from You or anyone acting on Your behalf having amended the Software or using it in breach of the Agreement, We will use commercially reasonable efforts to correct the issue to enable the Software to conform to the warranty at no additional cost to You. You will provide Us with a reasonable opportunity to remedy any breach, and make available information reasonably required to help Us to remedy the defect or fault, including sufficient information to enable Us to recreate the issue. The remedy in this clause 7.3 is the sole and exclusive remedy for Our failure to comply with the warranty in clause 7.1."

8.

Clause 13.1 of the EULA replaced:

The entire text of clause 13.1 is deleted and replaced with:

"13.1 SUBJECT TO CLAUSES 13.2, 13.3 AND 13.4, OUR MAXIMUM AGGREGATE LIABILITY UNDER OR IN CONNECTION WITH THE AGREEMENT (WHETHER IN CONTRACT, TORT (INCLUDING NEGLIGENCE) OR OTHERWISE) TO YOU, SHALL NOT EXCEED 25 GBP (TWENTY FIVE POUNDS)."

9.

Clause 13.7 added:

A new clause 13.7 is inserted into the EULA:

"13.7 BURP SUITE COMMUNITY EDITION IS DESIGNED TO TEST FOR SECURITY FLAWS AND CAN DO DAMAGE TO TARGET SYSTEMS DUE TO THE NATURE OF ITS FUNCTIONALITY. TESTING FOR SECURITY FLAWS INHERENTLY INVOLVES INTERACTING WITH TARGETS IN NON-STANDARD WAYS WHICH CAN CAUSE PROBLEMS IN SOME VULNERABLE TARGETS. YOU MUST TAKE DUE CARE WHEN USING THE SOFTWARE, MUST READ ALL DOCUMENTATION BEFORE USE AND BACK UP TARGET SYSTEMS BEFORE USE. WHERE YOU USE THE SOFTWARE ON PRODUCTION SYSTEMS OR OTHER SYSTEMS, YOU EXPRESSLY HEREBY ACCEPTS THE RISK OF DAMAGE AND RISK OF LOSS OF DATA OR LOSS OF USE IN RESPECT OF SUCH DATA AND SYSTEMS AND ACCEPTS THAT YOU SHOULD NOT USE THE SOFTWARE ON ANY SYSTEMS FOR WHICH YOU DO NOT ACCEPT THE RISK OF DAMAGE, RISK OF LOSS OF DATA OR LOSS OF USE."

10.

Clause 14.2 of the EULA replaced:

The entire text of clause 14.2 is deleted and replaced with:

"14.2 Without prejudice to clause 14.1, We shall be entitled to temporarily suspend Your usage of certain features of the Software (including scanning) where You use the Software in breach of the EULA (including Addendum D)."

11.

Addendum A - Reseller Terms deleted:

The entire text of Addendum A - Reseller Terms is deleted and replaced with the words "Not used."

2.2 Except as set out in clause 2.1, the EULA shall apply and continue in full force and effect at all times in respect of Your use of Burp Suite Community Edition.

2.3 To the extent of any conflict between the terms of the EULA and this Addendum D, the terms of this Addendum D shall prevail.

Portswigger Ltd - EULA issued April 2026 - DAST, Professional and Community
