...
Fetched: 2026-06-28T09:15:36.385809+00:00
...
To integrate Burp Suite DAST with Jenkins, we recommend using the site-driven scan option. In this section, we'll provide step-by-step instructions on the full configuration process.
