...
Fetched: 2026-06-28T09:15:46.711142+00:00
...
If your idea isn't entirely new, you might be better off tailoring an existing BApp to suit your purposes. You can find the source code for every extension in the BApp Store on our GitHub repository.
...
You should reference the montoya-api artifact using a build tool like Gradle or Maven. If you're starting a new project, we recommend using Gradle. For more information, see Creating Burp extensions.

It uses Burp AI as the default AI provider

Extensions that include AI functionality must use Burp AI as the default provider and follow the best practices outlined in Best practices for writing AI extensions. This ensures ease of setup for users, as they won't need to configure third-party API keys or services. It also enhances security, as all AI-related traffic is handled through Burp Suite's dedicated AI platform. You can also use third-party providers in addition to Burp AI.
