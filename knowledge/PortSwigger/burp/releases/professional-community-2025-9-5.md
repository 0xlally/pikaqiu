...
Source: https://portswigger.net/burp/releases/professional-community-2025-9-5
Fetched: 2026-06-28T09:16:56.833204+00:00
...
To get started, go to Extensions > Custom scan checks, then select New > Blank script.

For more information about custom scan checks, see Custom scan checks. To start writing them, check out our writing guide.
...
Clearer settings - We've reorganized the crawl and audit settings to make them easier to navigate. Setting names and descriptions are now clearer, so it's quicker to find and understand what you need.
...
To try the new layout, click New scan from the dashboard. For more information, see Configuring scans.
