...
class ObserverRuntime:
    ...
    def _system_prompt(self) -> str:
        return (
            ...
            "best practices. You may search or load experience as needed. Recommend a project skill when "
            "the current evidence, task context, memory, source hints, target behavior, or tool output suggests "
            "that a reusable workflow would improve the next few actions. Search/load skills only for your own "
            "judgement, then output a concise skill_signal that names the exact skill id and why activate_skill(...) "
            "fits this phase. Do not activate it yourself."
        )
    ...
    def _build_prompt(
        ...
        *,
        ...
        return (
            ...
            "6. Would a project skill materially improve the next few actions based on the current situation? If yes, "
            "use observer_skill_search/load_skill for your own judgement and finish with a concise skill_signal naming "
            "the skill id and why it fits; if the match is only a generic label or startup guess, leave skill_signal empty.\n"
